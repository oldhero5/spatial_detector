...
class DepthCalibrator:
    ...
    def calibrate_with_known_distance(self, normalized_depth: float, real_distance: float):
        """
    ...
    def load_calibration(self, file_path: str):
        ...
        try:
            ...
            print(f"Loaded calibration: scale={self.depth_scale}, offset={self.depth_offset}")
